...
try:
    from http.cookies import CookieError, SimpleCookie # Py3
except ImportError:
    from cookies import CookieError, SimpleCookie      # Py2
...
COOKIE_NAME_PREFIX = "QiC"  # identifies a cookie as being one used by gae-sessions (so you can set cookies too)
COOKIE_PATH = "/"
